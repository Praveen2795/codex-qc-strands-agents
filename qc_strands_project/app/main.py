...
def demo_workflow(*, verbose: bool = False, cursor: int = 0) -> dict:
    ...
    try:
        ...
        _persist_account_result(jsonl_path, {
            ...
            "sif_tag_check_result": _step_dec.get("acct-1b"),
            "sif_tag_check_reason": _step_rea.get("acct-1b"),
        ...
        _persist_account_result(jsonl_path, {
            ...
            "sif_tag_check_result": None,
            "sif_tag_check_reason": None,
...
def run_local_sequential_demo() -> dict:
    ...
    _persist_account_result(jsonl_path, {
        ...
        "sif_tag_check_result": dec_1b,
        "sif_tag_check_reason": tag_decision.get("reason"),
...
def run_multi_account_test() -> list[dict]:
    ...
    for acct in _TEST_ACCOUNTS:
        ...
        _persist_account_result(jsonl_path, {
            ...
            "settlement_flag": settlement_flag,
            "sif_tag_check_result": tag_decision.get("decision"),
            "sif_tag_check_reason": tag_decision.get("reason"),
